...
const House = (props: IHouse) => {
  ...
  const texture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ...
      : `${process.env.VITE_STATIC_PATH}/static/wall_pic5.jpg`
  );
  ...
  const roofTexture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ...
      : `${process.env.VITE_STATIC_PATH}/static/wall_pic7.png`
  );
  ...
  const floorTexture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ? '/static/floor_02.png'
      : `${process.env.VITE_STATIC_PATH}/static/floor_02.png`
  );
  ...
  const roadTexture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ? '/static/road2.jpg'
      : `${process.env.VITE_STATIC_PATH}/static/road2.jpg`
  );
  ...
  const grassTexture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ? '/static/grass.jpg'
      : `${process.env.VITE_STATIC_PATH}/static/grass.jpg`
  );
  ...
  const surfaceTexture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ? '/static/surface.jpg'
      : `${process.env.VITE_STATIC_PATH}/static/surface.png`
  );
  ...
  const crossTexture = new THREE.TextureLoader().load(
    process.env.NODE_ENV == 'development'
      ? '/static/cross.png'
      : `${process.env.VITE_STATIC_PATH}/static/cross.png`
  );
